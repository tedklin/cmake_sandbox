...
public:
	...
	ContinuousSystem(const Eigen::Matrix3d &A, 
	...
	const Eigen::EigenSolver<Eigen::Matrix3d>::EigenvalueType& GetEigenvalues() const;

	bool IsStable() const;

private:
	int STATE_DIM = 3; // eventually template this
	int INPUT_DIM = 1;
	using SCALAR = double;
